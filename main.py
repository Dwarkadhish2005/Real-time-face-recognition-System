...
#
#         if len(faceDis) > 0:  # Ensure there's a valid face distance
...
#
#                 id = studentIds[matchIndex]  # Assign the matched student ID
#                 if counter == 0:
#                     counter = 1
#                     modeType = 1
#
...
#                 studentInfo = {"total_attendance": 0}  # Provide default data
...
#         cv2.putText(imgBackground, str(studentInfo.get('name', 0)), (980, 445),
#                     cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
#         cv2.putText(imgBackground, "Major: " + str(studentInfo.get('major', 'N/A')), (980, 525),
#                     cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
#
#         cv2.putText(imgBackground, str(studentInfo.get('student_id', 0)), (980, 400),
#                     cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
